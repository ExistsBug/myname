...
public final class LXRiskLevelCheckMain_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("GBK"); 
      ...
      out.write("        <!-- 实现交互的区域 -->\r\n");
      out.write("        <frame id=\"fraInterface\" name=\"fraInterface\" scrolling=\"auto\" src=\"./LXCheckInfoInput.jsp?contno=");
      out.print(request.getParameter("contno"));
      out.write("&reviewScore=");
      out.print(request.getParameter("reviewScore"));
      out.write("&reviewLevel=");
      out.print(new String(request.getParameter("reviewLevel").getBytes("ISO-8859-1"),"GBK") );
      out.write("&customerNo=");
      out.print(request.getParameter("customerNo"));
      out.write("&poltype=");
