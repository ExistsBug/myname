...
public final class LXRiskLevelReviewMain_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ******************************************************************************/
      ...
      out.write("        <!-- 实现交互的区域 -->\r\n");
      out.write("        <frame id=\"fraInterface\" name=\"fraInterface\" scrolling=\"auto\" src=\"./LXReviewInfoInput.jsp?contno=");
      out.print(request.getParameter("contno"));
      out.write("&autoScore=");
      out.print(request.getParameter("autoScore"));
      out.write("&autoLevel=");
      out.print(new String(request.getParameter("autoLevel").getBytes("ISO-8859-1"),"GBK"));
