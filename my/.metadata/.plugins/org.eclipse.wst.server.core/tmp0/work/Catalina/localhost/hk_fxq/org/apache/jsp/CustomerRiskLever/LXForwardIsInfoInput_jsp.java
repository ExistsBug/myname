...
public final class LXForwardIsInfoInput_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/CustomerRiskLever/LXForwardIsInfoInit.jsp");
  }
 ...
 ******************************************************************************/
      ...
      out.write("    <!-- 私有引用脚本 -->\r\n");
      out.write("    <script language=\"JavaScript\" src=\"LXForwardIsInfoInput.js\"></script>\r\n");
      out.write("    ");
      out.write('\r');
      out.write('\n');
 ...
 ******************************************************************************/
      ...
      out.write("\t\t\tfm.all('StatiCode').value = ");
      out.print( tGI.ManageCom );
      out.write(";\r\n");
      out.write("\t\t\tshowOneCodeName(\"stati\",\"StatiCode\",\"StatiCodeName\");\r\n");
      out.write("        }\r\n");
      out.write("        catch (ex)\r\n");
      out.write("        {\r\n");
      out.write("            alert(\"在 LXForwardIsInfoInit.jsp --> initForm 函数中发生异常: 初始化界面错误！\");\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    /**\r\n");
      ...
      out.write("             iArray[i][0] = \"集体保单号\";\r\n");
      out.write("             iArray[i][1] = \"80px\";\r\n");
      out.write("             iArray[i][2] = 100;\r\n");
      out.write("             iArray[i++][3] = 0;\r\n");
      out.write("\r\n");
      out.write("             iArray[i] = new Array();//个合同号\r\n");
      out.write("             iArray[i][0] = \"保险合同号\";\r\n");
      out.write("             iArray[i][1] = \"80px\";\r\n");
      out.write("             iArray[i][2] = 100;\r\n");
      out.write("             iArray[i++][3] = 0;\r\n");
      out.write("             \r\n");
      out.write("             iArray[i] = new Array();\r\n");
      out.write("             iArray[i][0] = \"保单风险得分\";\r\n");
      out.write("             iArray[i][1] = \"60px\";\r\n");
      out.write("             iArray[i][2] = 100;\r\n");
      out.write("             iArray[i][7] = \"checkBoxNext\";\r\n");
      out.write("             iArray[i++][3] = 0;\r\n");
      out.write("\r\n");
      ...
      out.write("             CustomerGrid.hiddenPlus = 1;\r\n");
      out.write("             CustomerGrid.hiddenSubtraction = 1;\r\n");
      out.write("             CustomerGrid.canChk = 1;\r\n");
      out.write("             CustomerGrid.canSel = 0;\r\n");
      ...
      out.write("         catch (ex)\r\n");
      out.write("         {\r\n");
      out.write("             alert(\"在 LXForwardIsInfoInit.jsp --> initCustomerGrid 函数中发生异常: 初始化界面错误！\");\r\n");
      out.write("         }\r\n");
      out.write("     }\r\n");
      out.write("\r\n");
      out.write("    </script>\r\n");
      ...
      out.write("                <td class=\"titleImg\">高风险客户信息查询</td>\r\n");
      out.write("            </tr>\r\n");
      out.write("        </table>\r\n");
      ...
      out.write("                    onDblClick=\"return showCodeList('customerrisklevel',[this,CustomerLevelName],[0,1]);\" \r\n");
      out.write("                    onKeyUp=\"return showCodeListKey('customerrisklevel',[this,CustomerLevelName],[0,1]);\"\r\n");
      out.write("                    /><input class=codename name=\"CustomerLevelName\" readonly=true></td>\r\n");
      out.write("                \t<td  class=title>管理机构</td>\r\n");
      out.write("\t\t\t\t\t<td  class= input><Input class=codeno name=\"StatiCode\" readonly onDblClick=\"return showCodeList('station46',[this,StatiCodeName],[0,1]);\" onKeyUp=\"return showCodeListKey('station46',[this,StatiCodeName],[0,1]);\"><input class=codename name=\"StatiCodeName\" readonly=true></td>\r\n");
      out.write("                </tr>\r\n");
      out.write("                <tr>\r\n");
      ...
      out.write("                    <Input class= \"coolDatePicker\" dateFormat=\"short\" name=StartDate verify=\"交易发生起期|DATE\" >\r\n");
      out.write("                    </TD>\r\n");
      out.write("\r\n");
      out.write("               <TD  class= title>\r\n");
      out.write("                                               日期止期\r\n");
      out.write("                     </TD>\r\n");
      out.write("                   <TD  class= input>\r\n");
      out.write("                       <Input class= \"coolDatePicker\" dateFormat=\"short\" name=EndDate verify=\"交易发生止期|DATE\" >\r\n");
      out.write("                    </TD>\r\n");
      out.write("                </tr>\r\n");
      out.write("                 <tr class=\"common\">\r\n");
      ...
      out.write("                    <!--<td  class= input><Input class=codeno name=\"flowflag\" readonly onDblClick=\"return showCodeList('flowflag',[this,flowFlagName],[0,1]);\" onKeyUp=\"return showCodeListKey('flowflag',[this,flowFlagName],[0,1]);\"><input class=codename name=\"flowFlagName\" readonly=true></td>-->\t\r\n");
      out.write("                </tr>\r\n");
      out.write("            </table>\r\n");
      out.write("            <!-- 提交数据操作按钮 -->\r\n");
      ...
      out.print(tGe.ManageCom);
      out.write(")\">\r\n");
      out.write("           <!--  \r\n");
      out.write("             <input type=\"button\" class=\"cssButton\" value=\" 导  出 \" onclick=\"turnPageCustomerGrid.makeExcel('1|@^4|0.00_ ');\">\r\n");
      out.write("              \r\n");
      out.write("              -->\r\n");
      out.write("             <INPUT VALUE=\"导  出\" name=ExcelButton TYPE=button class=cssbutton onclick=\"GoToExcel();\"> \r\n");
      out.write("             \r\n");
      out.write("        </div>\r\n");
      out.write("        <!-- 交易信息折叠展开 -->\r\n");
      out.write("        <table>\r\n");
      ...
      out.write("                <td class=\"titleImg\">高风险客户信息列表</td>\r\n");
      out.write("            </tr>\r\n");
      out.write("        </table>\r\n");
      out.write("        <!-- 交易信息展现表格 -->\r\n");
