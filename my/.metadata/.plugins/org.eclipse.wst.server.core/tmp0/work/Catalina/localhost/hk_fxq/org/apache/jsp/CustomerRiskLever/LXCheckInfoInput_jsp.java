...
public final class LXCheckInfoInput_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/CustomerRiskLever/LXCheckInfoInit.jsp");
  }
 ...
 ******************************************************************************/
      ...
      out.write("    <!-- 私有引用脚本 -->\r\n");
      out.write("    <script language=\"JavaScript\" src=\"LXCheckInfoInput.js\"></script>\r\n");
 ...
 ******************************************************************************/
      ...
      out.write('	');
	   ...
	   reviewLevel = new String(reviewLevel.getBytes("ISO-8859-1"),"GBK");
	   String customerNo = request.getParameter("customerNo");
	   String poltype = request.getParameter("poltype");
	   String no = request.getParameter("no");
	   System.out.println(reviewLevel+"=============");
      ...
      out.print(contno);
      out.write("\";\r\n");
      out.write("\t\tvar reviewScore = \"");
      out.print(reviewScore);
      out.write("\";\r\n");
      out.write("\t\tvar reviewLevel = \"");
      out.print(reviewLevel);
      out.write("\";\r\n");
      ...
      out.write("    {\r\n");
      out.write("        fm.all('reviewScore').value = reviewScore;\r\n");
      out.write("        fm.all('reviewLevel').value = reviewLevel;\r\n");
      ...
      out.write("    <form name=\"fm\" action=\"./LXCheckInfoSave.jsp\" method=\"post\" target=\"fraSubmit\">\r\n");
      out.write("        <!-- 交易查询折叠展开 -->\r\n");
      out.write("        <table>\r\n");
      out.write("            <tr>\r\n");
      ...
      out.write("                <td class=\"titleImg\">审核确认</td>\r\n");
      out.write("            </tr>\r\n");
      out.write("        </table>\r\n");
      ...
      out.write("                    <td class=\"input\"><input type=\"text\" class=\"common\" name=\"reviewScore\" readonly></td>\r\n");
      out.write("                    <td class=\"title\">复评风险等级</td>\r\n");
      out.write("                    <td class=\"input\"><input type=\"text\" class=\"common\" name=\"reviewLevel\" readonly></td>\t\r\n");
      out.write("                </tr>\r\n");
      out.write("                 <tr class=\"common\">\r\n");
      out.write("\t\t\t\t\t<td class=\"title\">审核确认风险得分</td>\r\n");
      out.write("                    <td class=\"input\"><input type=\"text\" class=\"common\" name=\"checkScore\" onblur=\"calLevel();\" elementtype=nacessary verify=\"审核确认风险得分|NOTNULL&NUM\" ></td>\r\n");
      out.write("                    <td class=\"title\">审核确认风险等级</td>\r\n");
      out.write("                    <td class=\"input\"><input type=\"text\" class=\"common\" name=\"checkLevel\" readonly></td>\t\r\n");
      out.write("                </tr>\r\n");
      out.write("                <tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t<textarea style=\"width: 98%;height:50\" name=\"CheckRemark\" id=\"CheckRemark\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"common\" verify=\"备注|len<=200\"/></textarea>\r\n");
      out.write("\t\t\t        </TD>\r\n");
      out.write("\t\t\t    </tr>\r\n");
      out.write("            </table>\r\n");
      out.write("            <!-- 提交数据操作按钮 -->\r\n");
      ...
      out.write("            <input type=\"button\" class=\"cssButton\" value=\" 审核确认 \" onclick=\"checkSure();\">\r\n");
