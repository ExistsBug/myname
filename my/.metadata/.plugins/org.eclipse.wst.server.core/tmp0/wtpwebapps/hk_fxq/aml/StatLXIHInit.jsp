...
<%@ page contentType="text/html; charset=gb2312" language="java" errorPage="" %>
    ...
    <script language="JavaScript">
        ...
        function initForm()
        {
            ...
            {
                alert("在 StatLXIHInit.jsp --> initForm 函数中发生异常: 初始化界面错误！");
            }
        }
        ...
        function initInputBox()
        {
            ...
            {
                alert("在 StatLXIHInit.jsp --> initInputBox 函数中发生异常: 初始化界面错误！");
            }
        }
        ...
        function initStatGrid()
        {
            ...
            {
                alert("在 StatLXIHInit.jsp --> initStatGrid 函数中发生异常: 初始化数组错误！");
            }
            ...
            {
                alert("在 StatLXIHInit.jsp --> initStatGrid 函数中发生异常: 初始化界面错误！");
            }
        }
