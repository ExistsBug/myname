...
<SCRIPT src="CalModeIDCustomerInfo.js"></SCRIPT>
<%@include file="CalModeIDCustomerInfoInit.jsp"%>
</head>
<body  onload="initForm();initElementtype();" >
  <form action="./CalModeIDCustomerInfoSave.jsp" method=post name=fm target="fraSubmit">
    <table>
    	<tr>
    		<td>
...
<!--     	<BR>-->
     <tr>
     	<TD class=button>
          <input type =button class=cssbutton value="删  除" onclick="DeleteCalSave();"><font color=red style="font:9pt">  删除指定时间段内的所有数据</font>
     </TD>
     	</tr>
     	<BR>
     	<BR>
