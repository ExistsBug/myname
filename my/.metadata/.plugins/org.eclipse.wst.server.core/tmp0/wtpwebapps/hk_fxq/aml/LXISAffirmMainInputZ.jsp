...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="LXISAffirmMainZ.js"></script>
...
<body topmargin="0" onload="initForm()" ondragstart="return false">
    <form name="fm" method="post" target="fraSubmit">
        ...
        <div id="divWaitForBeFileSearch" style="display:''">
            ...
            <table class="common">
                ...
                <tr class="common">
                    ...
                    <TD  class= input><Input class=codeno name="RuleReason" readonly onDblClick="return showCodeList('rulereason',[this,RuleReasonName],[0,1]);" onKeyUp="return showCodeListKey('rulereason',[this,RuleReasonName],[0,1]);"><input class=codename name="RuleReasonName" readonly=true></TD> 											
        ...
        <div id="divWaitForBeFileGrid" style="display:''">
            ...
            <INPUT class=cssButton VALUE="确定报送" name="confirm" TYPE=button onclick="SubmitWaitForBeFileGrid(this.name);" />
            <INPUT class=cssButton VALUE="驳回" name="reject" TYPE=button onclick="SubmitWaitForBeFileGrid(this.name);" />
