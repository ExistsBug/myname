...
<html>
	...
	<head>
		<!-- 公共引用样式 -->
		<link href="../common/css/Project.css" type="text/css"
			rel="stylesheet">
		<link href="../common/css/mulLine.css" type="text/css"
			rel="stylesheet">
		<!-- 公共引用脚本 -->
		...
		<script language="JavaScript"
			src="../common/easyQueryVer3/EasyQueryVer3.js">
		</script>
		<script language="JavaScript"
			src="../common/easyQueryVer3/EasyQueryCache.js">
		</script>
		<script language="JavaScript"
			src="../common/javascript/VerifyInput.js">
		</script>
		<SCRIPT src="ISDataInterface.js"></SCRIPT>
		<%@include file="ISDataInterfaceInit.jsp"%>
	</head>
	<body onload="initForm();initElementtype();">
		<form action="./ISDataInterfaceSave.jsp" method=post name=fm
			target="fraSubmit">
			<table>
				<tr>
					<td>
			...
			<Div id="divAgent1" style="display: ''">
				<table class=common>
					<TR class=common>
						...
						<TD class=input>
							<Input class=codeno name="CalMngCom" readonly value="86"><input class=codename name="CalMngComName" value="弘康人寿保险股份有限公司"
								readonly=true>
							<font size=1 color='#ff0000'><b>*</b>
							</font>
						</TD>
						...
						<TD class=input>
							<Input class="coolDatePicker" dateFormat="short" name=StartDate
								verify="交易发生起期|DATE&NOTNULL" elementtype=nacessary>
						</TD>
						<TD class=title>
							交易发生止期
						</TD>
						<TD class=input>
							<Input class="coolDatePicker" dateFormat="short" name=EndDate
								verify="交易发生止期|DATE&NOTNULL" elementtype=nacessary>
						</TD>
					</TR>
				</table>
				<BR>
				<TD class=button>
					<input type=button class=cssbutton value="提  取"
						onclick="CalSave();">
					<input type=button class=cssbutton value="删  除"
						onclick="DeleteCalSave();">
					<INPUT VALUE="重  置" TYPE=button onclick="initForm1();"
						class="cssButton">
				...
				<tr>
					<TD class=button>
						<input type=button class=cssbutton value="重  提"
							onclick="ReCalSave();">
						<font color=red style="font: 9pt">重新提取指定时间段内的所有数据</font>
					</TD>
				</tr>
				<BR>
				<BR>
				<tr>
					<TD class=button>
						<input type=button class=cssbutton value="补  提"
							onclick="FillCalSave();">
						<font color=red style="font: 9pt"> 补提指定时间段内的所有未成功数据</font>
					</TD>
				</tr>
				<BR>
				<BR>
			...
			<table>
				<tr>
					<td>
						<IMG src="../common/images/butExpand.gif" style="cursor: hand;"
							OnClick="showPage(this,divAgent11);">
					</td>
					<td class=titleImg>
						提取信息查询
					</td>
			...
			<Div id="divAgent11" style="display: ''">
					...
					<TR class=common>
						...
						<TD class=input>
							<Input class="coolDatePicker" dateFormat="short"
								name="StartDate1" verify="交易发生起期|DATE">
						</TD>
						<TD class=title>
							交易发生止期
						</TD>
						...
						<TD class="input" />
							<Input name="Flag" id="Flag" class="codeno"
								...
								onkeyup="showCodeListKey('amllxcalflag',[this,FlagName],[0,1]);" /><Input class=codename name=FlagName readOnly>
						</TD>
					</TR>
				</table>
				<BR>
				<TD class=button>
					<input type=button class=cssbutton value="查    询"
						onclick="QueryGrid();">
					<INPUT VALUE="重  置" TYPE=button onclick="resetform1();"
						class="cssButton">
				</TD>
			</Div>
			<!-- 交易信息展现表格 -->
