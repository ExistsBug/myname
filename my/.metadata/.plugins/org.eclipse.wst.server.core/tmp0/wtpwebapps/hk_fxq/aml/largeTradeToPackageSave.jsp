...
<%
  ...
  CErrors tError = null;
  String sPacSavePath = application.getRealPath("/").replace('\\', '/');
    if (sPacSavePath != null && !sPacSavePath.endsWith("/"))
    {
        sPacSavePath += "/";
    }
         sPacSavePath += "aml/send/";
  AntiInit.filePath=sPacSavePath;
	AntiInit.packagePath=sPacSavePath;       
  String FlagStr = "";
  String Content = "";
  String tOperate="";
  ...
  if(dealType.equals("MakeAllInFileMsg"))
  {
  	...
  	tVData.add(tPackageNo);
  	tOperate=dealType;
	System.out.println("joylisten20070828");
  }
...
<script language="javascript">
	parent.fraInterface.afterSubmit("<%=FlagStr%>","<%=Content%>","<%=packagePath%>");
</script>
</html>