...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="DubitMsgMakeApply.js"></script>
    <%@ include file="DubitMsgMakeApplyInit.jsp" %>
</head>
<body topmargin="0" onload="initForm()" ondragstart="return false">
    <form name="fm" method="post" target="fraSubmit">
        ...
        <Input type=hidden id="CurrentDate" name="CurrentDate"><!--当前时间-->
    </form>
    <!-- 通用下拉信息列表 -->
