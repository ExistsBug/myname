...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="LXIHAudit.js"></script>
    <%@ include file="LXIHAuditInit.jsp" %>
</head>
<body topmargin="0" onload="initForm()" ondragstart="return false">
    <form name="fm" method="post" target="fraSubmit">
        ...
        <div id="divWaitForBeFileGrid" style="display:''">
            ...
            <INPUT class=cssButton VALUE="放弃申请" name="keep" TYPE=button onclick="SubmitWaitForBeFileGrid(this.name);" />
        <!-- 获取数据的隐藏域 -->
