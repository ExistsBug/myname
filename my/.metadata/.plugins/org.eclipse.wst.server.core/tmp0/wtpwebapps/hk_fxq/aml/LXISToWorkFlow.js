...
function queryStatGrid()
{
    var QuerySQL = "select "
                 ...
                 +        "CTNM, "
                 +        "DealDate "
                 +      "from LXISTradeMain where datastate = 'S00' and dealno not in ( select missionprop3 from lwmission where processid = '0000000009' ) "
...
function submitForm()
{
    ...
    document.forms(0).action = "LXISToWorkFlowSave.jsp?";
