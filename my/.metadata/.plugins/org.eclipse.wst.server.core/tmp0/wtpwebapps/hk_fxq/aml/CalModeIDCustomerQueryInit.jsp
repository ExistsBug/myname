...
function initForm()
{
  try
  {
      ...
      fm.all('tSalechnl').value = '';
      fm.all('paymode').value = '';
      fm.all('tPaymode').value = '';
      fm.all('transtype').value='';
       fm.all('tTranstype').value='';
       fm.all('transtype1').value='';
       fm.all('tTranstype1').value='';
       initTasksGrid();
  }
  catch(re)
  {
    alert("CalModeIDCustomerQueryInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
