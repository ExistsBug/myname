...
<SCRIPT src="DataInterface.js"></SCRIPT>
<%@include file="DataInterfaceInit.jsp"%>
</head>
<body  onload="initForm();initElementtype();" >
  <form action="./DataInterfaceSave.jsp" method=post name=fm target="fraSubmit">
    <table>
    	<tr>
    		<td>
