...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="PackageDownload.js"></script>
    <%@ include file="PackageDownloadInit.jsp" %>
</head>
<body topmargin="0" onload="initForm()" ondragstart="return false">
    <form name="fm" method="post" target="fraSubmit">
        ...
        <div id="divFilePkgSearch" style="display:''">
            ...
            <table class="common">
                ...
                <tr class="common">
                    ...
                    <td class="input"><input type="text" class="codeno" name="DataType" ondblclick="showCodeList('AmlPackageDataType',[this,DataTypeName],[0,1])" onkeyup="showCodeListKey('AmlPackageDataType',[this,DataTypeName],[0,1])"><input type="text" class="codename" name="DataTypeName" readonly></td>
        ...
        <div id="divFilePkgGrid" style="display:''">
            ...
            <!-- 提交数据操作按钮 -->
            <input type="button" class="cssButton" value=" 下 载 " onclick="downloadPackage()">
        </div>
        <!-- 获取数据的隐藏域 -->
