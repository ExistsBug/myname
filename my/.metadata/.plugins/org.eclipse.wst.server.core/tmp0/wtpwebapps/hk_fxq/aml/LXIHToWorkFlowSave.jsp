...
<%
    ...
    //调用后台处理
    LXIHToWorkFlowBL tLXIHToWorkFlowBL = new LXIHToWorkFlowBL();
    if (!tLXIHToWorkFlowBL.submitData(tVData, ""))
    {
       tErrors.copyAllErrors(tLXIHToWorkFlowBL.getErrors());
    }
    tLXIHToWorkFlowBL = null;
    tVData = null;
