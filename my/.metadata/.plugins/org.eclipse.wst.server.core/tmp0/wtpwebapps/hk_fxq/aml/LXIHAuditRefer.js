...
function queryWaitForBeFileGrid(usercode)
{
        ...
        var QuerySQL = "select a.DEALNo, "
                 ...
                 +        "case (select b.Missionprop15 from LWMission b where   a.DealNo = b.Missionprop3 and rownum = 1) when '09' then '放弃上报' else  '上报' end  "
...
//    }        
  ...
  fm.action="./LXIHAuditReferSave.jsp?dealno="+dealno+"&datastate="+datastate+"&oper="+str;
  fm.submit();
}