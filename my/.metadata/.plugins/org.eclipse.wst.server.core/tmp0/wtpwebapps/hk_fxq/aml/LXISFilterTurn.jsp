...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="LXISFilterTurn.js"></script>
    <%@ include file="LXISFilterTurnInit.jsp" %>
</head>
<body topmargin="0" onload="initForm(); initElementtype();" ondragstart="return false">
    ...
    VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV
-->
           <INPUT class=cssButton VALUE=" 直接分发  " name="zj" TYPE=button onclick="return GoToFilter(this.name);" />
            <INPUT class=cssButton VALUE=" 跳过财务 " name="tg" TYPE=button onclick="return GoToFilter(this.name);" />
  </form>
