...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="RlargeTradeFileToPackage.js"></script>
    <%@ include file="RlargeTradeFileToPackageInit.jsp" %>
</head>
<body topmargin="0" onload="initForm();initElementtype();" ondragstart="return false">
    <form name="fm" method="post" target="fraSubmit">
        ...
        -->
        <!-- 报文查询录入的层 -->
        <div id="divWaitForBeFileSearch" style="display:'none'">
            <!-- 报文查询录入表格 -->
            <table class="common">
                <tr class="common">
        ...
        <br><br>
        <!-- 提交数据操作按钮 -->
        <input type="button" class="cssButton" value="生成数据包" onclick="applyANewFileMsg()" name="makeAction">
