    ...
    <form name="fm" method="post" target="fraSubmit">
    	 <table>
            <tr>
                ...
                <td class="titleImg">风险级别计算</td>
            </tr>
        </table>
         <Div  id= "divTradeMain" style= "display: '' "/>
         	<br>
         <input type="button" class="cssButton" value=" 风险级别计算 " onclick="submitForm()">
         <br>
         </Div>
		<hr>
        <!-- 交易查询折叠展开 -->
            ...
            <table class="common">
                ...
                <tr class="common">
                    <td class="title" /> 风险级别</td>
				            <td class="input"/>
				                  <Input name="Grade" id="Grade" class="codeno" verify="风险级别|Code:amlriskgrade"
        ...
        <br>
         <input type="button" class="cssButton" value=" 导  出 " onclick="turnPageStatGrid.makeExcel('1|@^4|@_ ');">
         <br>
         <br>
    </form>
    <!-- 通用下拉信息列表 -->
