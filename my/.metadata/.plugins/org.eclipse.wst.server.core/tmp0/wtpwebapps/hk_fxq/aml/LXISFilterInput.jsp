...
-->
		...
		<table class="common">    	
            ...
            <INPUT class=cssButton VALUE="可  疑" name="yes" TYPE=button onclick="return GoToFilter(this.name);" />
            <INPUT class=cssButton VALUE="非可疑" name="no" TYPE=button onclick="return GoToFilter(this.name);" />
   </form>
