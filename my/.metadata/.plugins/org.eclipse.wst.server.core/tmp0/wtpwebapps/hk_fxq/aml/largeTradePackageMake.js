...
function queryFileMsgGrid()
{
    ...
    var QuerySQL = "select a.PackageNo, "
                 ...
                 if(fm.dataType.value=="02")
                 {
                        QuerySQL +=" and ((a.datatype in ('01','02') and a.DealState in ('04','05')) or (a.datatype in ('02') and a.DealState in ('02')) ) ";
                    }
                    else
                        {
...
function dealTheFileMsg()
{
        ...
        if(fm.dataType.value=="02")
    {
        ...
        {
            var sOpenWinURL = "largeTradeFileToPackageMain.jsp";
...
function applyANewFileMsg()
{
    ...
    fm.action="largeTradeToPackageSave.jsp?type=applyPackageNo&nPackageNo="+nPackageNo;
    fm.submit();
}
