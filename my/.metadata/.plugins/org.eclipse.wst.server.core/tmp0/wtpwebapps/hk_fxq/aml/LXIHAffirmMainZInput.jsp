...
<body topmargin="0" onload="initForm()" ondragstart="return false">
    ...
    <!--table>
        ...
        <Div  id= "divTasks" style= "display: '' "/>
            ...
            <br>
            <!-- 提交数据操作按钮 -->
            <!--INPUT class=cssButton VALUE="查看交易信息" name="ViewAndUpdate" TYPE=button onclick="GoToDetailInput(this.name);" /-->
            <INPUT class=cssButton VALUE="查看交易信息" name="ViewAndUpdate" TYPE=button onclick="GoToViewAndUpdate(this.name);" />
            <!--INPUT class=cssButton VALUE="修改交易信息" name="update" TYPE=button onclick="" /-->
