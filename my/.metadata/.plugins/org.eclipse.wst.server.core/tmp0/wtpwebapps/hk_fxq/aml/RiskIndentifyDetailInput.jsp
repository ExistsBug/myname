...
<SCRIPT src="RiskIndentifyDetail.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%-- @include file="..\common\jsp\CodeQueryApplet.jsp" --%>
<%@include file="RiskIndentifyDetailInit.jsp"%>
</head>
<body onload="initForm(); initElementtype();">
	<form action="./RiskIndentifyDetailSave.jsp" method=post name="fm" target="fraSubmit" >		
<!--
    VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV
                      引入合同基本信息录入控件         
    VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV
-->
<jsp:include page="RiskIndentifyDetailPage.jsp"/>
	...
	<table>
		...
		<jsp:include page="RiskIndentifyDetailPageC.jsp"/>
