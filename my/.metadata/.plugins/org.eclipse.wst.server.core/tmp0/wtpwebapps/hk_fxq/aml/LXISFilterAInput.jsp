...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="LXISFilterA.js"></script>
...
-->
		...
		<table class="common">    	
            ...
            <INPUT class=cssButton VALUE=" 通  过 " name="yes" TYPE=button onclick="return GoToFilter(this.name);" />
            <INPUT class=cssButton VALUE=" 不通过 " name="no" TYPE=button onclick="return GoToFilter(this.name);" />
   </form>
