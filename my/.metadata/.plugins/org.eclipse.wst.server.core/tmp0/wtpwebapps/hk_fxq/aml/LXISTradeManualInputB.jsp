...
<SCRIPT src="LXISTradeManualInputB.js"></SCRIPT>
<%@include file="LXISTradeManualInit.jsp"%>
</head>
<body onload="initForm(); initElementtype();">
<form action="./LXISTradeManualSave.jsp" method=post name=fm target="fraSubmit" >
    <table>
        <tr>
            <td class=common>
