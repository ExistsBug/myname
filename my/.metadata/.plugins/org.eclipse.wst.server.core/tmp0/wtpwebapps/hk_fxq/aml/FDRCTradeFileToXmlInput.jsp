...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="FDRCTradeFileToXml.js"></script>
    <%@ include file="FDRCTradeFileToXmlInit.jsp" %>
</head>
<body topmargin="0" onload="initForm()" ondragstart="return false">
    <form name="fm" method="post" target="fraSubmit">
        ...
        <div id="divWaitForBeFileGrid" style="display:''">
            ...
            <!-- 提交数据操作按钮 -->
            <input type="button" class="cssButton" value=" 添 加 " onclick="addToInFileMsg()" name="AddDealNo">
            <br>
        </div>
        <!-- 报文查询折叠展开 -->
        <table>
        ...
        <div id="divAlreadyInFileGrid" style="display:''">
            ...
            <!-- 提交数据操作按钮 -->
            <input type="button" class="cssButton" value=" 撤 销 " onclick="deleteInFileMsg()" name="DeleteDealNo">
        </div>
        <br><br>
        <!-- 提交数据操作按钮 -->
