...
<head >
		...
		<SCRIPT src="LXPRRISDetail.js"></SCRIPT>
		<%@include file="LXPRRISDetailInit.jsp"%>
		<title>可疑交易明细清单</title>
</head>
<body onload="initForm();" >
<form action="./LXPRRISDetailSave.jsp" method=post name=fm target=fraSubmit> 
