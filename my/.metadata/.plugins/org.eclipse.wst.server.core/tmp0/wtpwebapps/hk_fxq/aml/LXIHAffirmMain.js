...
function queryWaitForBeFileGrid(usercode)
{
        ...
        var QuerySQL = "select a.DEALNo, "
                 ...
                 +    " and c.activityid='0000009102' ) "
                 +     "and a.DataState in ('S00','S01','S04','S06','S09') "
...
function onClickRadioBoxGrid()
{
       ...
       if (checkFlag) 
       {
         var  dealState = WaitForBeFileGrid.getRowColData(checkFlag - 1, 8);
         //alert(dealState);
...
function SubmitWaitForBeFileGrid(str)
{
  ...
  fm.action="./LXIHAffirmMainSave.jsp?dealno="+dealno+"&datastate="+datastate+"&oper="+str+"&tActivity=0000009101 ";
  fm.submit();
