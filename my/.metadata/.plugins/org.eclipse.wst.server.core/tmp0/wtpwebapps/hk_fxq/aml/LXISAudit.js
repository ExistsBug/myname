...
function beforeSubmit()
{
    ...
    //---------------------cgh--2008.11.7--------<
    //alert(WaitForBeFileGrid.mulLineCount);
...
//  }
  ...
  fm.action="./LXISAuditSave.jsp?dealno="+dealno+"&datastate="+datastate+"&oper="+str;
  fm.submit();
