...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <script src="./LXISAffirmBackZInput.js"></script> 
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <%@include file="LXISAffirmBackZInit.jsp"%>
  ...
  <table class=common border=0>
			<TR class=common>
				<TD class="input" colspan=5  />
			        <textarea style="width:100%"  rows="8" name="ReMark" id="TKMS" class="common"  verify = "驳回原因|notnull&len<=128" elementtype=nacessary/></textarea>
		        </TD>
			</TR>
		</table>
 </Div>		
	<BR/><BR/>
      <INPUT VALUE="确认驳回" Class=cssButton TYPE=button Name=GiveUp onclick="giveUp();"> 
      &nbsp;&nbsp;
