...
<head >
		...
		<SCRIPT src="LXPRRISBaseInfo.js"></SCRIPT>
		<%@include file="LXPRRISBaseInfoInit.jsp"%>
		<title>可疑基本情况表</title>
</head>
<body onload="initForm();" >
<form action="./LXPRRISBaseInfoSave.jsp" method=post name=fm target=fraSubmit> 
