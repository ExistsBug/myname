    ...
    <form name="fm" method="post" target="fraSubmit">
        ...
        <div id="divWaitForBeFileSearch" style="display:''">
            ...
            <table class="common">
                ...
                <tr class="common">
                    <td class="title" /> 大额交易特征</td>
				            <td class="input"/>
				                  <Input name="CRCD" id="CRCD" class="code" verify="交易特征|Code:amlbigstamp"
				...
				<TD class="input"/>
			        <Input name="DataSource" id="DataSource" class="code"
	      					...
	      					onkeyup="showCodeListKey('DataSource',[this]);" verify="数据来源|notnull&Code:DataSource" elementtype=nacessary
	      					/>
		    </TD>	
              </tr>
            </table>
