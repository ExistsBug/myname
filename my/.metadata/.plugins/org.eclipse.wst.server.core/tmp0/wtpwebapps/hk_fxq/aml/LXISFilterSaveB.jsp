...
<%
    ...
    //调用后台处理
    LXDataFilterBUI tLXDataFilterUI = new LXDataFilterBUI();
    AMLWorkFlowUI flowUI = new AMLWorkFlowUI();
    try
    {
        if(!flowUI.submitData(tVData,"0000009222")){
    ...
    if (!tErrors.needDealError())
    {
        //--------------------------------------发送邮件功能--------------------------------------------//
						    ...
						    String EmailFrom = gSSRS.GetText(1,1);
		             	    ...
		             	    SSRS tSSRS = new SSRS();
		             	    String QuerySQL2="";
		             	    QuerySQL2 = " select Email from EmailTable  where 1=1  and managecom ='" +tGlobalInput.ComCode+ "' and Type='04' and State='00'";
