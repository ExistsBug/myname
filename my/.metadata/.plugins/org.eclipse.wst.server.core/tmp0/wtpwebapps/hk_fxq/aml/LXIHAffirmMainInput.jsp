...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="LXIHAffirmMain.js"></script>
...
<body topmargin="0" onload="initForm()" ondragstart="return false">
    ...
    <!--table>
        ...
        <Div  id= "divTasks" style= "display: '' "/>
            ...
            <INPUT class=cssButton VALUE="提交上级审核" name="affirm" TYPE=button onclick="SubmitWaitForBeFileGrid(this.name);" />
