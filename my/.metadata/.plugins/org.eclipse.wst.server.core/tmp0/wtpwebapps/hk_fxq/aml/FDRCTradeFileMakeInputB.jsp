...
<head>
    ...
    <!-- 私有引用脚本 -->
    <script language="JavaScript" src="FDRCTradeFileMake.js"></script>
    <%@ include file="FDRCTradeFileMakeInit.jsp" %>
</head>
<body topmargin="0" onload="initForm();initElementtype();" ondragstart="return false">
    <form name="fm" method="post" target="fraSubmit"  action="FDRCTradeToXmlSave.jsp?type=applyFileNo">
        <!-- 报文查询折叠展开 -->
        <table>
            <tr>
