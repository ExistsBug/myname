    ...
    <table  class= common align=center>
       ...
       <TR  class= common>
        ...
        <TR  class= common>          
          ...
          <TD  class= input> <Input class="coolDatePicker" name=MakeDate verify="投保人出生日期|notnull&date"> </TD>
          <TD  class= title> 入机时间 </TD>
          <TD  class= input> <Input class=common name=MakeTime verify="投保人出生日期|notnull&date"> </TD>
          <TD  class= title> 最后一次修改日期 </TD>
          <TD  class= input> <Input class="coolDatePicker" name=ModifyDate verify="投保人出生日期|notnull&date"> </TD>
        </TR>
        
        <TR  class= common>
          <TD  class= title> 最后一次修改时间 </TD>
          <TD  class= input> <Input class= common name=ModifyTime verify="投保人出生日期|notnull&date"> </TD>
        </TR>
